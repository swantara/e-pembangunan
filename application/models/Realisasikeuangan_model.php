 ...
 //                sum(chek.nilai) as total_realisasi
	...
	public function getrealisasiall()
	{
		...
		$query = $this->db->query("select sp.*,
				...
				sum(case when month(c.tgl_cair) = 11 then c.nilai else 0 end) as total_nop,
				sum(case when month(c.tgl_cair) = 12 then c.nilai else 0 end) as total_des,
				(sum(case when month(c.tgl_cair) = 1 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 2 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 3 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 4 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 5 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 6 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 7 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 8 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 9 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 10 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 11 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 12 then c.nilai else 0 end)) as total_realisasi,
	...
	public function getsumrealisasiall()
	{
		...
		$query = $this->db->query("select sp.*,
				c.tgl_cair,
				sum(case when month(c.tgl_cair) = 1 then c.nilai else 0 end)/1000000000 as total_jan,
				sum(case when month(c.tgl_cair) = 2 then c.nilai else 0 end)/1000000000 as total_feb,
				sum(case when month(c.tgl_cair) = 3 then c.nilai else 0 end)/1000000000 as total_mar,
				sum(case when month(c.tgl_cair) = 4 then c.nilai else 0 end)/1000000000 as total_apr,
				sum(case when month(c.tgl_cair) = 5 then c.nilai else 0 end)/1000000000 as total_mei,
				sum(case when month(c.tgl_cair) = 6 then c.nilai else 0 end)/1000000000 as total_jun,
				sum(case when month(c.tgl_cair) = 7 then c.nilai else 0 end)/1000000000 as total_jul,
				sum(case when month(c.tgl_cair) = 8 then c.nilai else 0 end)/1000000000 as total_agt,
				sum(case when month(c.tgl_cair) = 9 then c.nilai else 0 end)/1000000000 as total_sep,
				sum(case when month(c.tgl_cair) = 10 then c.nilai else 0 end)/1000000000 as total_okt,
				sum(case when month(c.tgl_cair) = 11 then c.nilai else 0 end)/1000000000 as total_nop,
				sum(case when month(c.tgl_cair) = 12 then c.nilai else 0 end)/1000000000 as total_des,
	...
	public function getsumrealisasiopd()
	{
		...
		$query = $this->db->query("select sp.*,
				c.tgl_cair,
				sum(case when month(c.tgl_cair) = 1 then c.nilai else 0 end)/1000000 as total_jan,
				sum(case when month(c.tgl_cair) = 2 then c.nilai else 0 end)/1000000 as total_feb,
				sum(case when month(c.tgl_cair) = 3 then c.nilai else 0 end)/1000000 as total_mar,
				sum(case when month(c.tgl_cair) = 4 then c.nilai else 0 end)/1000000 as total_apr,
				sum(case when month(c.tgl_cair) = 5 then c.nilai else 0 end)/1000000 as total_mei,
				sum(case when month(c.tgl_cair) = 6 then c.nilai else 0 end)/1000000 as total_jun,
				sum(case when month(c.tgl_cair) = 7 then c.nilai else 0 end)/1000000 as total_jul,
				sum(case when month(c.tgl_cair) = 8 then c.nilai else 0 end)/1000000 as total_agt,
				sum(case when month(c.tgl_cair) = 9 then c.nilai else 0 end)/1000000 as total_sep,
				sum(case when month(c.tgl_cair) = 10 then c.nilai else 0 end)/1000000 as total_okt,
				sum(case when month(c.tgl_cair) = 11 then c.nilai else 0 end)/1000000 as total_nop,
				sum(case when month(c.tgl_cair) = 12 then c.nilai else 0 end)/1000000 as total_des,
	...
	public function getrealisasitriwulan()
	{
		...
		$query = $this->db->query("select sp.*,
				c.tgl_cair,
				(sum(case when month(c.tgl_cair) = 1 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 2 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 3 then c.nilai else 0 end)) as triwulan_1,
				(sum(case when month(c.tgl_cair) = 4 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 5 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 6 then c.nilai else 0 end)) as triwulan_2,
				(sum(case when month(c.tgl_cair) = 7 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 8 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 9 then c.nilai else 0 end)) as triwulan_3,
				(sum(case when month(c.tgl_cair) = 10 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 11 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 12 then c.nilai else 0 end)) as triwulan_4,
				(sum(case when month(c.tgl_cair) = 1 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 2 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 3 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 4 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 5 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 6 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 7 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 8 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 9 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 10 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 11 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 12 then c.nilai else 0 end)) as total_realisasi,
				count(c.tahun) as jumlah_data
			from t_sp2d sp
			inner join t_cheque c on sp.no_sp2d = c.no_sp2d
	...
	public function getsumrealisasitriwulan()
	{
		...
		$query = $this->db->query("select sp.*,
				c.tgl_cair,
				(sum(case when month(c.tgl_cair) = 1 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 2 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 3 then c.nilai else 0 end))/1000000 as triwulan_1,
				(sum(case when month(c.tgl_cair) = 4 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 5 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 6 then c.nilai else 0 end))/1000000 as triwulan_2,
				(sum(case when month(c.tgl_cair) = 7 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 8 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 9 then c.nilai else 0 end))/1000000 as triwulan_3,
				(sum(case when month(c.tgl_cair) = 10 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 11 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 12 then c.nilai else 0 end))/1000000 as triwulan_4,
				(sum(case when month(c.tgl_cair) = 1 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 2 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 3 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 4 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 5 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 6 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 7 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 8 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 9 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 10 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 11 then c.nilai else 0 end)+sum(case when month(c.tgl_cair) = 12 then c.nilai else 0 end))/1000000 as total_realisasi,
				count(c.tahun) as jumlah_data
			from t_sp2d sp
			inner join t_cheque c on sp.no_sp2d = c.no_sp2d
