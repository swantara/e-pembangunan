      ...
      <div class="page-header-content">
        <div class="page-title align-center">
          ...
          <h4>
            ...
            <span class="text-semibold"> Detail Realisasi Fisik</span> 
          </h4>
          <p>
            Nama Kegiatan
          </p>
      ...
      <div class="content-wrapper">
          ...
          <div class="col-lg-12">
            <div class="panel panel-flat">
              <div class="panel-heading">
                <h5 class="panel-title"><i class="icon-clipboard2 mr-10"></i><strong>Detail Realisasi Fisik</strong></h5>
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="panel panel-flat">
              <div class="panel-heading">
                <h5 class="panel-title"><i class="icon-clipboard2 mr-10"></i><strong>Dokumentasi</strong></h5>
                <div class="heading-elements">
                  <ul class="icons-list">
                    <li><a data-action="collapse"></a></li>
                  </ul>
              ...
              <div class="panel-body">
                <div>
                  ...
                  <div class="row">
                    <div class="col-md-3">
                      <img class="img-responsive" src="<?=base_url('assets/images/backgrounds/kantor-bupati.jpg')?>">
                    </div>
                    <div class="col-md-3">
                      <img class="img-responsive" src="<?=base_url('assets/images/backgrounds/kantor-bupati.jpg')?>">
                    </div>
