        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Nyoman Swantara</span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  Nyoman Swantara
                  <small>Dinas Kominfo Kab. Badung</small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="report-rask.php">
            <i class="fa fa-institution"></i> <span>RASK</span>
          </a>
        </li>
        <li>
          <a href="report-kontrak.php">
            <i class="fa fa-copy"></i> <span>Kontrak</span>
          </a>
        </li>
        <li>
          <a href="report-realisasi-keuangan.php">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="progress.php"><i class="fa fa-line-chart"></i> Lihat Progress</a></li>
