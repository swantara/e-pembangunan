			...
			<div class="page-header-content">
				<div class="page-title align-center">
					...
					<h4>
						...
						<span class="text-semibold"> Grafik Realisasi Keuangan</span> 
					</h4>
				</div>
			</div>
		</div>
					...
					<div class="col-lg-12">
						<div class="panel panel-flat">
							<div class="panel-heading">
								<h5 class="panel-title"><i class="icon-stats-growth mr-10"></i><strong>Grafik Realisasi Keuangan</strong></h5>
