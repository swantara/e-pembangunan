			...
			<div class="content-wrapper">
					...
					<div class="col-lg-12">
						<div class="panel panel-flat">
							<div class="panel-heading">
								<h6 class="panel-title">Rencana Paket Pengadaan &amp; Struktur Anggaran</h6>
									...
									<div class="mt-minus-30 tab-content">
										<div class="tab-pane active" id="basic-tab1">
											...
											<div class="table-responsive">
												<table class="table table-gradient" style="width: 100%;">
									        <thead style="text-align: center;" id="headsummaryukp4">
									        	<tr>
									        		<td rowspan="3">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="panel panel-flat">
							<div class="panel-heading">
								<h6 class="panel-title">Progres Keuangan &amp; Progres Fisik</h6>
								<div class="heading-elements">
									<ul class="icons-list">
                		<li><a data-action="collapse"></a></li>
                	</ul>
